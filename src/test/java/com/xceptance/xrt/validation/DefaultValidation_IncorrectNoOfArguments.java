...
public class DefaultValidation_IncorrectNoOfArguments
{
    /****************************************************************************************
     ...
     */
    public static String expValStatusCode = "This status code should not be shown: ";
     ...
     */
    public static void validateStatusCode( int statusCode, String value )
    {
